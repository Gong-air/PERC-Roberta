...
speaker_vocab_dict_path = r'vocabs\emory_speaker_vocab.pkl'
emotion_vocab_dict_path = r'vocabs\emory_emotion_vocab.pkl'
sentiment_vocab_dict_path = r'vocabs\emory_sentiment_vocab.pkl'

CONFIG = {
    'data_path' : './MELD/data/emorynlp/'
}
...
def load_meld_and_builddataset(additional,file_path, train=False):
    with open('emorynlp_withoutanswer_' + additional + '.json', 'w') as file:
        with open('emorynlp_withanswer_' + additional + '.json', 'w') as answerfile:
        ...
        # for prompt roberta
        with open('prompt_emorynlp_' + additional + '.json', 'w') as file:
